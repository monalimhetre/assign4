...
def createtable():
    ...
    myConn = pymysql.connect(host='instance2.comsbkfo5i2h.us-east-2.rds.amazonaws.com', user='admin', passwd='Mona12345678',
                     db='myDatabase2',local_infile=True)
    cursor = myConn.cursor()
    file_name = 'D:/Cloud-Computing/Cloud-Computing/Assignment-4/StateVotingClean.csv'
    ...
    uploadqry="""LOAD DATA LOCAL INFILE 'D:/Cloud-Computing/Cloud-Computing/Assignment-4/StateVotingClean.csv'
